...
- Мидлвар валидации добавлен только для net/http и gin. Для других мидлвары можно найти тут: https://github.com/oapi-codegen/oapi-codegen#requestresponse-validation-middleware
